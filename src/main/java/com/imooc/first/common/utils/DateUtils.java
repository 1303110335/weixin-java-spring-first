...
public class DateUtils {
    ...
    public static final String FORMAT_DATETIME_HH = "yyyyMMddHH";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getDaysBetweenToDate(new Date(), caled.getTime()));
    }
    ...
    public final static String formatDate4YYMMDD() {
        return format(FORMAT_DATETIME_YYMMDD);
    }
    ...
    public final static String formatLongDateTime12Quarter(Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        if (date.getSeconds() >= 10) {
            int ten = date.getSeconds() / 10;
            if (date.getSeconds() >= ten * 10 + 5)
                calendar.set(Calendar.SECOND, ten * 10 + 5);
            else
                calendar.set(Calendar.SECOND, ten * 10);
        } else {
        ...
        return format(calendar.getTime(), FORMAT_DATETIME_LONG);
    }
     ...
     * yyyyMMddHH
     */
    public final static String formatateTimeHH() {
        return format(FORMAT_DATETIME_HH);
    }
    ...
    public static int getDaysDiff(Date end, Date start) {
        Calendar calst = Calendar.getInstance();
        Calendar caled = Calendar.getInstance();
        if (getDaysBetweenToDate(end, start) < 0) {
            calst.setTime(end);
            caled.setTime(start);
        } else {
            calst.setTime(start);
    ...
    public static Date beforeXDayLastTime(Date date, Integer X) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.add(Calendar.DATE, X);
     ...
     * @return
     */
    public static Date beforeXDayWalletRate(Date date, Integer X) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.add(Calendar.DATE, X);
    ...
    /**
     * 返回当前时间增加分钟数后的时间 "yyyy-MM-dd HH:mm:ss"
     *
     * @param date
     * @return
     */
    public final static String getDateTimeAddMinute(int minute) {
        return getDateTimeAddMinute(minute, FORMAT_DATETIME);
    }
     ...
     * @return
     */
    public final static String getDateTimeAddMinute(int minute, String format) {
        Date date = new Date();
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
